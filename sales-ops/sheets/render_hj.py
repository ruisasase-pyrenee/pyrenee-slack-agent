...
async def main():
    async with async_playwright() as p:
        ...
        html = (SCR/"hojicha_src.html").read_text()
        s = 1.0
        for _ in range(6):
        ...
        await pg.pdf(path=str(SCR/"FirstAgri_Hojicha_Organic_2026-08.pdf"), format="A4",
                     print_background=True, scale=s, margin={"top":"0","bottom":"0","left":"0","right":"0"})
        await pg.screenshot(path=str(SCR/"hj_pv.png"), full_page=True)
