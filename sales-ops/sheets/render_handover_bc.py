...
SRC = pathlib.Path("../豪州出張ハンドオーバー_会社別.md")
OUT = pathlib.Path("FirstAgri_AU_Handover_ByCompany_2026-08.pdf")
...
<section class="cover">
  ...
  <h1>豪州出張ハンドオーバー<br>会社別</h1>
  <div class="rule"></div>
  <div class="meta">
    <b>対象期間</b>　2026-07-21 メルボルン入り → シドニー → 2026-08-18 US発<br>
    <b>担当</b>　笹瀬 類（Global Sales Manager &amp; Founding Member）<br>
    <b>収録</b>　67社（会社別・連絡先つき）<br>
    <b>最終更新</b>　2026-08-19
  </div>
  <div class="warn"><b>取り扱い注意</b>　顧客名・担当者名・価格・粗利を含む社内資料です。対外配布はしないでください。
  ✅確定と⚠️推定をラベルで分けています。受注前の案件を受注として扱わないこと。</div>
</section>
__BODY__
</body></html>"""
    ...
    async with async_playwright() as p:
        ...
        await pg.pdf(path=str(OUT), format="A4", print_background=True,
            ...
            footer_template='<div style="width:100%;font-size:7px;font-family:sans-serif;'
              ...
              '<span>First Agri Inc.　豪州出張ハンドオーバー　2026-08-18　社内資料</span>'
